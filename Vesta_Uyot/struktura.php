...
<head>
    ...
    <title>Практика Онлайн - <?php echo $pageTitle; ?></title>
    ...
    <header class="bg-white shadow-sm">
        <div class="container">
            <div class="d-flex align-items-center justify-content-center py-3">
                <img src='images/logog3.png' alt='логотип' class="me-3" style="width: 80px; height: auto;">
                <h1 class="h3 mb-0">Практика Онлайн</h1>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h3 class="h6 mb-0">2025 &copy; Практика Онлайн</h3>
                </div>
            </div>
        </div>
    </footer>
